...
public class ExPlugin extends PluginAdapter {
    ...
    public boolean sqlMapUpdateByExampleSelectiveElementGenerated(XmlElement element,
        ...
        sb.append("update ");
        sb.append(introspectedTable.getAliasedFullyQualifiedTableNameAtRuntime().replace("${tablesite}",
                                                                                         "${record.tablesite}"));
    ...
    private void addTableSite(TopLevelClass topLevelClass, IntrospectedTable introspectedTable, String name) {
